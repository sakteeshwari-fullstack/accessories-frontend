...
import ContactPopup from "../../components/Popup/Popup"; // ✅ Import the Popup
...
export default function NavbarMobileMenu({ isOpen, onClose, menuData }) {
  ...
  const renderIcon = (iconName) => {
    switch (iconName) {
      case "Heart":
        return <Heart className="w-5 h-5 text-gray-800" />;
      case "ShoppingCart":
        return <ShoppingCart className="w-5 h-5 text-gray-800" />;
      case "User":
        return <User className="w-5 h-5 text-gray-800" />;
      default:
        return null;
    }
  };
        ...
        >
            ...
            {menuData
              ...
              .map((item, index) => (
                <Link
                  key={index}
                  href={item.href}
                  className="flex items-center justify-center w-12 h-12 border border-gray-200 rounded-full hover:bg-orange-100 transition shadow-sm"
                >
          ...
          <div className="space-y-3">
            <button
              ...
              className="bg-orange-600 text-white px-4 py-2 w-full rounded-md flex items-center justify-center gap-2 hover:bg-black transition cursor-pointer"
            >
